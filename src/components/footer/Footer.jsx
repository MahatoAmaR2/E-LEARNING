    ...
    <>
      <footer className="bg-[#060131] px-10 py-10 flex gap-x-8 ">
        <div className="w-[40%]">
          <div className="text-gray-400 ">
            ...
            <p className="text-[14px] mt-2 tracking-widest">
              <span className="text-[12px] ">&copy; </span>copyright CubicleS
              2023 - 2024. All rights reserved.
            </p>
            <p className="mt-4 text-[14px] tracking-widest">
              Home for learners
            </p>
          </div>
        </div>
        <div className="flex w-[60%] ">
          ...
          <div className="flex-1">
            <p className="text-green-200 mb-2 text-[18px] font-medium">
              Socials
            </p>
          ...
          <div className="flex-1">
            <p className="text-green-200 text-[18px] font-medium mb-2 ">
              Register
            </p>
            <div className="flex flex-col gap-y-2 text-[14px] cursor-pointer">
              <p> Sign Up</p>
